...
- `flowcraft.roles.giztest.yaml` creates isolated narrator/nils/akka Workspaces and requires text EOS, audio EOS, non-empty Opus, timing evidence, and role-specific text.
