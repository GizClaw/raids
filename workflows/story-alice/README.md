...
| --- | --- | --- | --- | --- | --- |
| 1. 迟到的怀表 | first opening request | resolve this chapter's core tension | observe a concrete consequence; compare the two characters' responses | player resolves the current hook and requests chapter 2 | emit the chapter 2 heading once, followed directly by that chapter's opening scene |
...
- `eino.multi-role.yaml`: `eino-story-alice-multi-role`; Voice aliases: `eino-story-alice-mr.storyteller`, `eino-story-alice-mr.alice`, `eino-story-alice-mr.white-rabbit`, `eino-story-alice-mr.hatter`, `eino-story-alice-mr.cheshire-cat`, `eino-story-alice-mr.queen-of-hearts`.
- `flowcraft.multi-role.yaml`: `flowcraft-story-alice-multi-role`; Voice aliases: `flowcraft-story-alice-mr.storyteller`, `flowcraft-story-alice-mr.alice`, `flowcraft-story-alice-mr.white-rabbit`, `flowcraft-story-alice-mr.hatter`, `flowcraft-story-alice-mr.cheshire-cat`, `flowcraft-story-alice-mr.queen-of-hearts`.
