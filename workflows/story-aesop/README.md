...
- `flowcraft.roles.giztest.yaml` creates isolated narrator/tortoise/bird Workspaces and requires text EOS, audio EOS, non-empty Opus, timing evidence, and role-specific text.
