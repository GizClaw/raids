...
- `eino.multi-role.yaml`: `eino-story-fengshen-multi-role`; Voice aliases: `eino-story-fengshen-mr.storyteller`, `eino-story-fengshen-mr.nezha`, `eino-story-fengshen-mr.jiang-ziya`, `eino-story-fengshen-mr.yang-jian`, `eino-story-fengshen-mr.lei-zhenzi`.
- `flowcraft.multi-role.yaml`: `flowcraft-story-fengshen-multi-role`; Voice aliases: `flowcraft-story-fengshen-mr.storyteller`, `flowcraft-story-fengshen-mr.nezha`, `flowcraft-story-fengshen-mr.jiang-ziya`, `flowcraft-story-fengshen-mr.yang-jian`, `flowcraft-story-fengshen-mr.lei-zhenzi`.
