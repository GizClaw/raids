...
- `flowcraft.roles.giztest.yaml` creates isolated narrator/axel/lidenbrock Workspaces and requires text EOS, audio EOS, non-empty Opus, timing evidence, and direct, speaker-label-free role text.
