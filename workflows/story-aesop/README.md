...
- `eino.multi-role.yaml`: `eino-story-aesop-multi-role`; Voice aliases: `eino-story-aesop-mr.storyteller`, `eino-story-aesop-mr.tortoise`, `eino-story-aesop-mr.bird`, `eino-story-aesop-mr.rabbit`, `eino-story-aesop-mr.fox`.
- `flowcraft.multi-role.yaml`: `flowcraft-story-aesop-multi-role`; Voice aliases: `flowcraft-story-aesop-mr.storyteller`, `flowcraft-story-aesop-mr.tortoise`, `flowcraft-story-aesop-mr.bird`, `flowcraft-story-aesop-mr.rabbit`, `flowcraft-story-aesop-mr.fox`.
