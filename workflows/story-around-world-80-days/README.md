...
- Cast: narrator (visible facts and transitions), 福格 (`fogg`), and 艾娥达 (`aouda`); each character keeps a distinct motive, voice, and knowledge boundary.
...
| --- | --- | --- | --- | --- | --- |
| 1. 伦敦启程 | first opening request | resolve this chapter's core tension | observe a concrete consequence; compare the two characters' responses | player resolves the current hook and requests chapter 2 | emit the chapter 2 heading once, followed directly by that chapter's opening scene |
...
| 4. 归期谜底 | chapter 3 transition satisfied and player explicitly continues | resolve this chapter's core tension | observe a concrete consequence; compare the two characters' responses | player confirms a durable choice and one remaining responsibility | remain in chapter 4; keep one post-ending responsibility |
...
- `flowcraft.roles.giztest.yaml` creates isolated narrator/fogg/aouda Workspaces and requires text EOS, audio EOS, non-empty Opus, timing evidence, and direct, speaker-label-free role text.
...
- `eino.multi-role.yaml`: `eino-story-around-world-80-days-multi-role`; Voice aliases: `eino-story-around-world-80-days-mr.storyteller`, `eino-story-around-world-80-days-mr.fogg`, `eino-story-around-world-80-days-mr.aouda`, `eino-story-around-world-80-days-mr.passepartout`, `eino-story-around-world-80-days-mr.fix`.
- `flowcraft.multi-role.yaml`: `flowcraft-story-around-world-80-days-multi-role`; Voice aliases: `flowcraft-story-around-world-80-days-mr.storyteller`, `flowcraft-story-around-world-80-days-mr.fogg`, `flowcraft-story-around-world-80-days-mr.aouda`, `flowcraft-story-around-world-80-days-mr.passepartout`, `flowcraft-story-around-world-80-days-mr.fix`.
