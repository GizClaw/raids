...
| --- | --- | --- | --- | --- | --- |
| `eino.yaml` | `eino-learn-science-grade4` | eino | learner | `eino-learn-science-grade4.model` | `eino-learn-science-grade4.tutor` |
...
every other grade, about 3007 characters in total. Every experiment
...
- `tests/giztest/smoke/learn-science-grade4.<implementation>.giztest.yaml`: speed, latency and responsiveness.
- `tests/giztest/quality/learn-science-grade4.<implementation>.giztest.yaml`: quality control and safety guardrails.
- `tests/giztest/soak/learn-science-grade4.<implementation>.giztest.yaml`: long-turn Tester relay with reload.

Run `make test-e2e TIER=smoke RAID=learn-science-grade4`. Each tier has one file per implementation, run concurrently with `PARALLEL=4`; see [the test guide](../../tests/giztest/README.md) for budgets and failure reporting.
