...
- `tests/giztest/smoke/learn-math-grade2.giztest.yaml`: speed, latency and responsiveness.
- `tests/giztest/quality/learn-math-grade2.giztest.yaml`: quality control and safety guardrails.
- `tests/giztest/soak/learn-math-grade2.giztest.yaml`: long-turn Tester relay with reload.

Run `make test-e2e TIER=smoke RAID=learn-math-grade2`. Each tier file covers all implementations; see [the test guide](../../tests/giztest/README.md) for budgets and failure reporting.
